async function fetchPoisonPokemons() {
...
async function createPoisonCards() {
    ...
    pokes.forEach(p => {
        ...
        card.innerHTML = `
            ...
            <div class="info-grid">
                <div><strong>Altura</strong><br>${height} m</div>
                <div><strong>Defesa</strong><br>${defense}</div>
                <div><strong>Peso</strong><br>${weight} kg</div>
            </div>
